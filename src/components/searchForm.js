      ...
      <div className="flex flex-col h-[25%] w-[30%] ml-auto mr-auto mt-[8%] gap-12">
        {departureTerminal === "TSA" ?
          <>
            <button
              name="destination"
              className="py-1 text-center rounded-md bg-primary shadow-md text-primary-content hover:bg-primary-focus hover:shadow-2xl hover:-translate-y-px"
              onClick={getInput}
              value={ferryRoutes.SWARTZ_BAY}
            >
              Swartz Bay
            ...
            <button
              name="destination"
              className="py-1 text-center rounded-md bg-primary shadow-md text-primary-content hover:bg-primary-focus hover:shadow-2xl hover:-translate-y-px transition-opacity delay-75"
              onClick={getInput}
              value={ferryRoutes.DUKE_POINT}
            >
              Duke Point
        ...
        {departureTerminal === "HSB" ?
          <>
            <button
              className="py-1 text-center rounded-md bg-primary shadow-md text-primary-content hover:bg-primary-focus hover:shadow-2xl hover:-translate-y-px transition-opacity delay-150"
              onClick={getInput}
              value={ferryRoutes.NANAIMO}
            >
              Nanaimo
            ...
            <button
              name="destination"
              className="py-1 text-center rounded-md bg-primary shadow-md text-primary-content hover:bg-primary-focus hover:shadow-2xl hover:-translate-y-px transition-opacity delay-175"
              onClick={getInput}
              value={ferryRoutes.LANGDALE}
            >
              Langdale
            ...
            <button
              name="destination"
              className="py-1 text-center rounded-md bg-primary shadow-md text-primary-content hover:bg-primary-focus hover:shadow-2xl hover:-translate-y-px transition-opacity delay-200"
              onClick={getInput}
              value={ferryRoutes.BOWEN_ISLAND}
            >
              Bowen Island
